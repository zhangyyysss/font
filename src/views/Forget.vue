            ...
            <div class="layui-form layui-form-pane">
              <form method="post">
                <div class="layui-form-item">
                  ...
                  <div class="layui-input-inline">
                    <input type="text" id="L_email" name="email" autocomplete="off" class="layui-input" v-validate="'required|email'" v-model="username">
                  </div>
                  <div class="layui-form-mid">
                ...
                <div class="layui-form-item">
                  ...
                  <div class="layui-input-inline">
                    <input type="text" id="L_vercode" name="code" placeholder="请回答后面的问题" autocomplete="off" class="layui-input" v-validate="'required|length:4'" maxlength="4" v-model="code">
                  </div>
                  <div>
                    <span v-html="svg"></span>
                  </div>
                  <div class="layui-form-mid" @click="_getCode()">
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      submit () {
        forget({
          username: this.username, // 把邮箱和验证发送到后台
          code: this.code
        }).then(res => {
          console.log(res)
          if (res.code === 200) {
